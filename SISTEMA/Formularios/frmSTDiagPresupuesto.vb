Public Class frmSTDiagPresupuesto
    ...
    Private Sub btnTodo_FontChanged(sender As Object, e As EventArgs) Handles btnTodo.FontChanged
    ...
    Private Sub frmSTDiagPresupuesto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = "SERVICIO TECNICO: DIAGNOSTICO Y PRESUPUESTO - " & mdifrmppal.encForm
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            If resP = Windows.Forms.DialogResult.OK Then
                _Guardar.Grabar("Servivio Tecnico", "NoImagen", "modDiagyPresupuesto", CInt(lblIdServTecnico.Text), txtDiagnostico.Text, _
                                Format(CDate(txtFecEntrega.Text), "yyyy/MM/dd"), CDbl(txtPresupuesto.Text), txtObaserv.Text)
        ...
        Try
            If Asc(e.KeyChar) = Keys.Enter Then
                If txtBuscCliente.Text = "" Then
                    e.Handled = True
                    frmClientes.lblOrigen.Text = "Servicio Tecnico Buscar Diagnostico"

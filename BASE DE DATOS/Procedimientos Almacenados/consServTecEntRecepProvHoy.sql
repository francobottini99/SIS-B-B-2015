CREATE DEFINER=`root`@`localhost` PROCEDURE `consServTecEntRecepProvHoy`(
	in unnST varchar(45),
    in fecEnt date
)
BEGIN
	...
	WHERE
		ServicioTecnico.CodUN = unnST And ServicioTecnico.Estado = "En Reparacion Terceros" And ServicioTecnico.FecEntregaProv = fecEnt
